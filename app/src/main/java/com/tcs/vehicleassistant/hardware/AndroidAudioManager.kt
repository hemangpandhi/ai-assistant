...
class AndroidAudioManager(
    ...
    private var audioFocusRequest: AudioManager.AudioFocusRequest? = null
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            if (audioFocusRequest == null) {
                val attributes = android.media.AudioAttributes.Builder()
                    ...
                    .build()
                audioFocusRequest = AudioManager.AudioFocusRequest.Builder(
            ...
            audioFocusRequest?.let { systemAudio.requestAudioFocus(it) }
        }
    }

    private fun abandonFocus() {
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            audioFocusRequest?.let { systemAudio.abandonAudioFocusRequest(it) }
        }
    }
