...
object SystemPromptBuilder {
    ...
    fun capabilityReminder(): String = buildString {
        ...
        append("When the user gives a clear command and a matching tool is listed below, ")
        ...
        append("Never emit multiple <TOOL> tags in a single response, and DO NOT output any conversational text until ALL tools have been executed.\n")
