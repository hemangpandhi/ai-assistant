...
class WakeWordEngine(
    ...
    private fun initializeModels() {
        models.forEach { model ->
            val processor = ModelProcessor(model)
     ...
     * @see detections
     */
    fun feedAudio(audioBuffer: FloatArray) {
        scope.launch {
    ...
    private inner class ModelProcessor(
        ...
        private val modelRunner = OnnxModelRunner(model.modelPath)
        private val audioProcessor = AudioProcessor(modelRunner)
