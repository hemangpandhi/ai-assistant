 ...
 * ADB:
 * ```
 * adb shell am start -n com.assistant.ui/.ui.gallery.AssistantUiGalleryActivity
 * ```
 */
class AssistantUiGalleryActivity : ComponentActivity() {
    ...
    companion object {
        ...
        const val ACTION_OPEN_GALLERY = "com.assistant.ui.action.OPEN_ASSISTANT_GALLERY"
    }
}
