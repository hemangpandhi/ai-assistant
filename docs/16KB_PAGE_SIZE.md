...
| `libspeech_android.so` (`app/libs/soniqo-speech.aar`) | 4096 | **FAIL** |

Until Soniqo rebuilds that AAR with `-Wl,-z,max-page-size=16384`, the tablet may still
show a warning for that **one** library.
