...
import com.test.design.assistant.ui.chrome.assistantChromePadding
...
import com.test.design.assistant.face.AssistantContextGlyphIcon
import com.test.design.assistant.face.AssistantFaceKind
import com.test.design.assistant.face.AssistantMood
import com.test.design.assistant.face.ConfigurableAssistantFace
...
fun ImmersiveAssistantBottomChrome(
    ...
    BoxWithConstraints(
        ...
        // Upper bound raised so a +20% scale is not clipped by the old 200.dp cap.
        val faceSize = (bandHeight * 0.64f * faceSizeScale).coerceIn(88.dp, 240.dp)
