 ...
 * ADB:
 * ```
 * adb shell am start -n com.test.design/.ui.overlay.AssistantOverlayBootstrapActivity
 * adb shell am startservice -n com.test.design/.ui.overlay.AssistantOverlayService
 * ```
 */
