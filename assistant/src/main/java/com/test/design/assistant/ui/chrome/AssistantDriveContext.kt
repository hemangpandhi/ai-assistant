...
import com.test.design.assistant.audio.isAffirmativeUtterance
import com.test.design.assistant.audio.isNegativeUtterance

/**
 * Cabin-agnostic helpers for mood / gaze / gestures.
 * Proactive drive beats live in [com.test.design.assistant.backend.buildCabinBeats]
