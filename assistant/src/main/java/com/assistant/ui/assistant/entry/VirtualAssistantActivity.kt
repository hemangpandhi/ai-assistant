package com.assistant.ui.assistant.entry
 ...
 *   -n com.assistant.ui/.entry.VirtualAssistantActivity
 * ```
 */
class VirtualAssistantActivity : ComponentActivity() {
    ...
    companion object {
        const val ACTION_OPEN_ASSISTANT = "com.assistant.ui.action.OPEN_ASSISTANT"
