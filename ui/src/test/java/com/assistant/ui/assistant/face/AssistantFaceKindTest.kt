...
class AssistantFaceKindTest {
    ...
    fun parsesCanonicalKeys() {
        ...
        assertEquals(AssistantFaceKind.ClassicHybrid, AssistantFaceKind.parse("classichybrid"))
    ...
    fun parsesAliases() {
        ...
        assertEquals(AssistantFaceKind.ClassicHybrid, AssistantFaceKind.parse("classic_hybrid"))
        assertEquals(AssistantFaceKind.ClassicHybrid, AssistantFaceKind.parse("shell_hybrid"))
        assertEquals(AssistantFaceKind.ClassicHybrid, AssistantFaceKind.parse("master_hybrid"))
        assertEquals(AssistantFaceKind.ClassicHybrid, AssistantFaceKind.parse("hybridshell"))
    ...
    fun adbKeysAreUnique() {
        ...
        assertTrue(keys.contains("classichybrid"))
